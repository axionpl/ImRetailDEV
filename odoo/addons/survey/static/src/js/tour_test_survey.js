...
tour.register('test_survey', {
    ...
    [
        ...
        {
            content: "For 'I use the contextual help in ImRetail' checking 'Agree'",
        ...
        // Question: What do you think about the process views of ImRetail, available in the web client ?
        {
            content: "For 'They help new users to understand ImRetail' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to ImRetail?
        {
