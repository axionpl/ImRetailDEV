...
/**
 * This is the base class inherited by all (JS) views. ImRetail JS views are the
 ...
 * the word 'view' has historical significance in ImRetail code, so we replaced the
