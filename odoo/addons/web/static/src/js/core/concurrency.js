 ...
 * everything concurrency related in ImRetail.
 *
 * The basic concurrency primitives in ImRetail JS are the callback, and the
...
return {
    ...
    /**
     * A (ImRetail) mutex is a primitive for serializing computations.  This is
